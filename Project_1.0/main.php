...
if(isset($_POST['submit'])){
      ...
      if(!empty($fileName) === true)
      {
            ...
            $query = "UPDATE `my_table` SET `Start Time` =STR_TO_DATE( `Start Time`,  '%d-%c-%Y %H:%i')";
            //echo $query;
            $mysql_con->query($query);
...
if(isset($_POST['submit2'])){
  ...
  //************************************************************************
  $query = "SELECT * FROM my_table WHERE `Start Time` >= '$from_date 00:00:00' AND `Start Time`<= '$to_date 23:59:00'";
